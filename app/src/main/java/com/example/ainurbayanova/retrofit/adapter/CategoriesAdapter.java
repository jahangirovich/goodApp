...
public class CategoriesAdapter extends RecyclerView.Adapter<CategoriesAdapter.EmployeeViewHolder> {
    ...
    public EmployeeViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.design_of_recycler, parent, false);
        ...
        EmployeeViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    clickItemInterface.onClick(getAdapterPosition());
                }
            });
        }
    }
